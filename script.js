...
const TRANSLATIONS = {
    zh: {
        ...
        'hero-desc': '宜路科技整合 Dell Technologies 企業級產品與 VMware 虛擬化平台，攜手 CrowdStrike、KnowBe4、SecurityScorecard<br>頂尖資安品牌，提供從基礎建設到資安防護的一站式專業服務。',
        'hero-btn1': '立即諮詢方案',
        'hero-btn2': '瞭解我們的服務',
        'stat-label1': '企業客戶信賴',
        'stat-label2': '服務滿意度',
        ...
        'about-p2': '我們提供 Dell Technologies 全方位企業級產品的整合服務，涵蓋 PowerEdge 伺服器、PowerStore/PowerScale 儲存、企業網路設備、Precision 工作站到 Latitude 商用筆電。同時，我們整合 VMware 企業虛擬化平台與全球資安領導品牌 —— CrowdStrike Falcon 端點防護、KnowBe4 資安意識培訓、以及 SecurityScorecard 供應鏈風險管理，為企業建構從虛擬化基礎架構到端點與供應鏈的完整防護體系。',
        'about-f1-h': '專業產品整合',
        'about-f1-p': '提供 Dell Technologies 全系列企業級產品的規劃、部署與技術服務',
        'about-f2-h': '專業認證團隊',
        ...
        // Dell
        'dell-tag': 'Dell Technologies Products',
        'dell-title': 'Dell Technologies 全系列企業級產品',
        'dell-desc': '我們提供 Dell Technologies 全系列企業級產品的專業整合服務',
        ...
        // Security
        'sec-tag': 'Virtualization & Cybersecurity',
        'sec-title': '虛擬化與資安解決方案',
        'sec-desc': '整合企業虛擬化平台與全球頂尖資安品牌，為企業建構完整的數位基礎架構與安全防線',
        ...
        'vmw-desc': '全球企業虛擬化與軟體定義資料中心的領導平台。VMware vSphere 透過業界最成熟的 Hypervisor 技術，協助企業實現運算、儲存與網路的全面虛擬化。搭配 vSAN 超融合架構與 NSX 網路虛擬化，可將硬體利用率提升至 <strong>80% 以上</strong>，同時降低 IT 營運成本達 <strong>50%</strong>。',
        'vmw-btn': '諮詢 VMware 方案',
        ...
        'why1-h3': '原廠產品保障',
        'why1-p': '所有 Dell Technologies 產品皆為原廠正品，享有完整原廠保固與技術支援。',
        'why2-h3': '一站式整合服務',
        'why2-p': '從硬體採購、資安部署到維運管理，提供完整生命週期服務，讓企業專注核心業務。',
        'why3-h3': '頂尖資安生態系',
        'why3-p': '策略整合 VMware 虛擬化平台與 CrowdStrike、KnowBe4、SecurityScorecard 資安品牌，覆蓋虛擬化、端點、人員、供應鏈。',
        'why4-h3': '在地化專業團隊',
        ...
        'faq1-a': '我們提供 Dell Technologies 全系列企業級產品的整合服務，包含 PowerEdge 伺服器、PowerStore/PowerScale/PowerProtect/PowerVault 儲存、Precision 工作站、Latitude 商用筆電、OptiPlex 桌機、網路交換器及 UltraSharp 顯示器。虛擬化方面，我們整合 VMware vSphere、vSAN、NSX、VCF 等完整虛擬化套件。資安方面，我們整合 CrowdStrike、KnowBe4 與 SecurityScorecard 三大國際品牌的解決方案。',
        'faq2-q': '我的企業規模不大，也適合使用這些資安解決方案嗎？',
        'faq2-a': '當然適合。VMware、CrowdStrike、KnowBe4 與 SecurityScorecard 都提供彈性的授權方案，可依企業規模與預算靈活調整。我們會根據您的實際需求，推薦最適合且最具成本效益的方案組合，而非一味推銷高階產品。',
        ...
        // Partners
        'partners-h3': '整合品牌',
        'partners-sub': '整合全球領先品牌，為台灣企業提供世界級的 IT 解決方案',
        // Testimonials
        ...
        'footer-desc': '專業可靠的系統整合商，整合 Dell Technologies 全方位產品、VMware 虛擬化平台與頂尖資安品牌，為企業打造堅不可摧的 IT 基礎架構與資安防線。',
        'footer-col1-h4': '服務項目',
    ...
    en: {
        ...
        'hero-desc': 'YILU Technology integrates Dell Technologies enterprise products and VMware virtualization with world-class cybersecurity brands CrowdStrike, KnowBe4 &amp; SecurityScorecard,<br>delivering one-stop professional IT &amp; security services.',
        ...
        'stat-label4': 'Global Brands Integrated',
        ...
        'about-p2': 'We provide integration services for Dell Technologies\' full enterprise product lineup, including PowerEdge servers, PowerStore/PowerScale storage, enterprise networking, Precision workstations, and Latitude laptops. We also integrate the VMware enterprise virtualization platform and leading cybersecurity brands — CrowdStrike Falcon, KnowBe4, and SecurityScorecard — to build a comprehensive posture from virtualized infrastructure to endpoint and supply chain security.',
        'about-f1-h': 'Expert Integration',
        'about-f1-p': 'Professional planning, deployment, and technical services for Dell Technologies enterprise products',
        ...
        'dell-desc': 'We provide professional integration services for the full Dell Technologies enterprise product portfolio',
        ...
        // Security
        'sec-tag': 'Virtualization & Cybersecurity',
        'sec-title': 'Virtualization & Cybersecurity Solutions',
        'sec-desc': 'Integrating enterprise virtualization and world-class security solutions to build complete digital infrastructure and defenses',
        ...
        'vmw-desc': "The world's leading enterprise virtualization and software-defined data center platform. VMware vSphere uses the industry's most mature hypervisor technology to enable full compute, storage, and network virtualization. Combined with vSAN hyper-converged storage and NSX network virtualization, it can boost hardware utilization to <strong>over 80%</strong> while reducing IT operational costs by up to <strong>50%</strong>.",
        'vmw-btn': 'Inquire About VMware',
        ...
        'why1-h3': 'Genuine Product Assurance',
        'why1-p': 'All Dell Technologies products are genuine with full factory warranty and technical support.',
        ...
        'why3-p': 'Strategically integrated VMware virtualization with CrowdStrike, KnowBe4, and SecurityScorecard — covering virtualization, endpoint, people, and supply chain.',
        ...
        'faq1-a': "We provide integration services for Dell Technologies' full enterprise lineup, including PowerEdge servers, PowerStore/PowerScale/PowerProtect/PowerVault storage, Precision workstations, Latitude laptops, OptiPlex desktops, network switches, and UltraSharp monitors. For virtualization, we integrate VMware vSphere, vSAN, NSX, VCF, and the full virtualization suite. On the security side, we integrate solutions from CrowdStrike, KnowBe4, and SecurityScorecard.",
        'faq2-q': 'Are these security solutions suitable for smaller companies?',
        'faq2-a': 'Absolutely. VMware, CrowdStrike, KnowBe4, and SecurityScorecard all offer flexible licensing that scales with your company size and budget. We recommend the most cost-effective combination for your actual needs — never oversell.',
        ...
        // Partners
        'partners-h3': 'Integrated Brands',
        'partners-sub': 'Integrating global leading brands to deliver world-class IT solutions to Taiwan enterprises',
        // Testimonials
        'test-tag': 'Testimonials',
        ...
        'form-opt-vmw': 'VMware Virtualization Solutions',
        ...
        'footer-desc': 'A reliable system integrator combining Dell Technologies, VMware virtualization, and elite cybersecurity brands to build unbreakable IT infrastructure and digital defenses for enterprises.',
