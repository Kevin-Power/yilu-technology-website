...
const TRANSLATIONS = {
    zh: {
        ...
        'about-p2': '我們提供 Dell Technologies 全方位企業級產品的整合服務，涵蓋 PowerEdge 伺服器、PowerStore/PowerScale 儲存、企業網路設備、Precision 工作站到 Latitude 商用筆電。同時，我們整合全球資安領導品牌 —— CrowdStrike Falcon 端點防護平台、KnowBe4 資安意識培訓、以及 SecurityScorecard 供應鏈風險管理，為企業建構從端點到供應鏈的完整資安防護體系。',
        'about-f1-h': '專業產品整合',
        ...
        'faq1-a': '我們提供 Dell Technologies 全系列企業級產品的整合服務，包含 PowerEdge 伺服器、PowerStore/PowerScale/PowerProtect/PowerVault 儲存、Precision 工作站、Latitude 商用筆電、OptiPlex 桌機、網路交換器及 UltraSharp 顯示器。資安方面，我們整合 CrowdStrike、KnowBe4 與 SecurityScorecard 三大國際品牌的解決方案。',
    ...
    en: {
        ...
        'sec-desc': 'Integrating world-class security solutions to build a complete digital defense from endpoint to supply chain',
